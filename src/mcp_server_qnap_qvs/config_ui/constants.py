...
MCP_SSL_PORT = int(os.environ.get("MCP_SSL_PORT", "8444"))
MCP_SSL_CERT = os.environ.get("MCP_SSL_CERT", "")
MCP_HAS_SSL = bool(MCP_SSL_CERT and os.path.exists(MCP_SSL_CERT))
...
# Optional Docker registry auth fields (separate section in the UI)
# Image name is intentionally not configurable — prevents supply chain attacks
REGISTRY_FIELDS = [
